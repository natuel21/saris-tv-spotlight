    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          areaServed: "ET",
          knowsAbout: [
            "Ethiopian digital media",
            "Business and entrepreneurship in Ethiopia",
            "Ethiopian market prices",
            "Electronics and product prices in Addis Ababa",
            "Property and real estate in Addis Ababa",
            "Entertainment, movies, music and television",
            "Content creators and online trends",
            "Ethiopian lifestyle, culture and travel",
            "Business opportunities",
          ],
          sameAs: [
            "https://www.youtube.com/@SarisTvEthiopia",
            "https://www.instagram.com/saris_media_ethiopia",
            "https://www.facebook.com/share/1MRwDHPJoc/",
            "https://www.tiktok.com/@sarismedia",
          ],
        }),
      },
      {
        ...
        children: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "WebSite",
          "@id": "https://sarismultimedia.com/#website",
          url: "https://sarismultimedia.com",
          name: "Saris TV Ethiopia",
          alternateName: ["Saris TV", "Saris Media", "ሳሪስ ቲቪ"],
          inLanguage: ["en", "am"],
